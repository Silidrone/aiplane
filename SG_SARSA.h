...
class SG_SARSA : public GPI<State, Action> {
   protected:
    const double step_size;
    ApproximationValueStrategy<State, Action>* m_value_strategy;

   public:
    SG_SARSA(MDP<State, Action>* mdp_core, Policy<State, Action>* policy,
    ...
    void sg_sarsa_main() {
        ...
        do {  // episode loop
            ...
            //     std::vector<std::string> feature_descriptions = {"MyPosX: Normalized X position of agent",
            ...
            //                                                      "ActionX: Normalized X action",
            //                                                      "ActionY: Normalized Y action",
            //                                                      "Bias: Constant term"};
    ...
    void policy_iteration() override { sg_sarsa_main(); }
};