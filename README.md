...
Please note that you need to install both matplotplusplus and libtorch (with those exact directory names) in the root of the project to be able to run it.
