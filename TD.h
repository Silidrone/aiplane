...
class TD : public GPI<State, Action> {
   protected:
    ...
    DerivedStochasticPolicy<State, Action>* m_policy;
    const double step_size;

   public:
    TD(MDP<State, Action>& mdp_core, DerivedStochasticPolicy<State, Action>* policy, const double discount_rate,
